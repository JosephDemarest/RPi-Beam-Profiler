...
# Colours
d_purple = [126.0 / 255.0, 49.0 / 255.0,
            123.0 / 255.0]  #	Palatinate Purple	255C
...
def main(filename):
  ...
  axmain.imshow(imgdata,
                aspect='auto',
                extent=[0, len(imgX), len(imgY), 0],
                cmap=cmap)
  ...
  axmain.tick_params(direction='in',
                     color='w',
                     bottom=1,
                     top=1,
                     left=1,
  ...
  axH.tick_params(direction='in',
                  ...
                  left=1,
                  right=1,
                  color=2 * np.array(d_black))
  axV.tick_params(direction='in',
                  bottom=1,
                  top=1,
                  left=1,
                  right=1,
